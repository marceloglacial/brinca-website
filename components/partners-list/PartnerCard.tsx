      ...
      <Card.Body className='text-center lg:text-left'>
        <div className='flex flex-wrap lg:flex-nowrap gap-8 justify-center lg:justify-start'>
          ...
          <div className='w-full'>
            <h4 className='text-[20px]'>Nostrud consectetur id fugiat</h4>
            <p className='text-[16px] leading-normal'>
              Pariatur anim quis Lorem ipsum Lorem. Esse ut enim fugiat ea
              nostrud incididunt enim sint qui culpa proident.
            </p>
          </div>
        </div>
        <div className='w-full'>
