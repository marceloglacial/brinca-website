...
const content = {
  ...
  description: (
    <p>
      Officia exercitation labore proident nisi qui nisi sint fugiat in. Sit culpa in eiusmod velit
      proident veniam elit aute aute velit aute officia commodo irure. Reprehenderit do do sunt qui
      magna sit.
    </p>
  ),
  image: (
        ...
        <div className='flex flex-wrap justify-center gap-8 lg:flex-nowrap lg:justify-start'>
          ...
          <div className='w-full'>
            ...
            <p className='text-[16px] leading-normal'>
              Pariatur anim quis Lorem ipsum Lorem. Esse ut enim fugiat ea nostrud incididunt enim
              sint qui culpa proident.
            </p>
          </div>
        </div>
        <div className='w-full'>
