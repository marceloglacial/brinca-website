...
export const localizedContent = (content: any, locale?: string): any => {
...
export const localizedData = (data: any, locale?: string): any =>
  data.map((item: any) => localizedContent(item, locale))
